function generateID() {
  ...
  var hotel1=makehotel(new Date(),'El Mouradi',"200 Dt/nuit",'4 Stars')
  ...
  $("p4").text(hotel1.star)
   ...
   var hotel2=makehotel(new Date(),"Radisson Palace","250 Dt/nuit","5 Stars")
  ...
  var hotel3=makehotel(new Date(),"Royal Azur","180 Dt/nuit","4 Stars")
