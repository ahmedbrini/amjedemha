...
function generateID() {
  ...
  var hotel1=makehotel(new Date(),'Movenpick',"350 Dt/nuit",'5 Stars',"All inclusive")
  ...
  $("p13").text(hotel1.descr)
   ...
   var hotel2=makehotel(new Date(),"Jazz Tour","150 Dt/nuit","3 Stars","Demi pension")
  ...
  var hotel3=makehotel(new Date(),"Marhaba","200 Dt/nuit","4 Stars","Demi pension")
