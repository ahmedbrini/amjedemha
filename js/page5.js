function generateID() {
  ...
  var hotel1=makehotel(new Date(),'Movenpick',"350 Dt/nuit",'5 Stars')
  ...
  $("p4").text(hotel1.star)
   ...
   var hotel2=makehotel(new Date(),"Jazz Tour","150 Dt/nuit","3 Stars")
  ...
  var hotel3=makehotel(new Date(),"Marhaba","200 Dt/nuit","4 Stars")
